...
export default function RemovalPolicy({}: Props) {
  return (
    <div className="container">
      <h1 className="mt-5">Privacy Policy</h1>
      <p className="mb-5">
        Joel Transport is committed to ensuring that your privacy is protected.
        ...
        only be used in accordance with this privacy statement. Joel Transport
        ...
        with any changes. This policy is effective from 1-1-2018.
      </p>

      <Accordion>
        <Accordion.Item eventKey="0">
          <Accordion.Header>What we collect</Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="3">
          <Accordion.Header>How we use cookies</Accordion.Header>
          <Accordion.Body>
            <p>
        ...
        <Accordion.Item eventKey="5">
          ...
          <Accordion.Body>
            ...
            info@joeltransport.co.za. We will not sell, distribute or lease your
            personal information to third parties unless we have your permission
            or are required by law. We may use your personal information to send
            ...
            to info@joeltransport.co.za. If you believe that any information we
