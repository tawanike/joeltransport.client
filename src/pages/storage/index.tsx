                        ...
                        <div className="col-6">
                            <div className="row">
                                ...
                                <div className="col-6 moves__container__summary">
                                    <div>
                                        <p><b>Storage type: wooden crate unit </b></p>
                                        <p><b>Storage units size: 6 m2</b></p>
                                        <p className='price'><span>R350 pm</span> excl.VAT</p>
                                        <p>Each storage unit can fit items in a one-bedroom bachelor apartment.</p>
                                    </div>
                                </div>
                            </div>
