  ...
  return (
    <div className="Resources container-fluid">
      <CoverImage
        ...
        variant="--storage"
        description="Your storage needs + our expertise = convenience."
      />
              ...
              <div className="row">
                ...
                <div className="col-12 col-md-6 mt-3 mt-md-0 moves__container__summary">
                  <div>
                    ...
                    <p>
                      Each storage unit has enough space to fit items that would
                      fill a bachelor apartment.
                    </p>
                  </div>
                </div>
              </div>
