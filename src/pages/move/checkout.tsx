                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 moves__checkout__summary__list mt-3">
                                        <div className="row">
                                            ...
                                            <div className="col-6 moves__checkout__summary__list__edit" onClick={() => bookingContext.dispatch({ type: CHANGE_OPEN_SECTION, payload: { openSection: "move_details" } })}>
                                                Edit
                                            </div>
                                    ...
                                    <div className="col-12 moves__checkout__summary__list mt-3">
                                        <div className="row">
                                            ...
                                            <div className="col-6 moves__checkout__summary__list__edit" onClick={() => bookingContext.dispatch({ type: CHANGE_OPEN_SECTION, payload: { openSection: "truck" } })}>
                                                Edit
                                            </div>
                                        </div>
                                    </div>
