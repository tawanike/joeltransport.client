                    ...
                    opps ?
                        <>
                            <div className="row">
                                ...
                                <div className="col-12 resources__careerEntry mt-5" onClick={() => setOpps(!opps)}>
                                    <div className="col-12">
                                        <div className="row p-4">
                                            ...
                                            <div className="col-12 resources__careerEntry__text mb-4">
                                                <p>
                                                    JOB SUMMARY: GermistonCode 14 drivers are required for Centurion PDP or dangerous goods/ 3 years exp Matric R70 hourly rate.
                                                </p>
                                            </div>
                                            <div className="col-9 resources__careerEntry__fulltime">
                                                <p><span className="clock"><BsClock /></span> Full time</p>
                                            </div>
                        ...
                        <>
                            <div className="col-8 offset-2 resources__emptyCareers p-5" onClick={() => setOpps(!opps)}>
                                <div className="col-12 resources__modal__icon danger">
                                    <BsFillExclamationSquareFill />
                                </div>
                                <div className="col-12 resources__modal__head mt-4">
                                    <h3>There are no current openings
                                    </h3>
                                </div>
                                <div className="col-8 offset-2 resources__modal__text mt-4">
                                    <p>Thank you for your interest, but there are no job openings
                                        available at this time. Please check back at another time</p>
                                </div>
