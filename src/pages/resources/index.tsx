          ...
          <div className="row">
            <div className="resources__product-description col-12">
              <div className="row">
                ...
                <div className="resources__downloads col-12 col-md-6">
                  <ul className="row">
                    <li className="col-6 resources__downloads__outline mb-5">
                      <div className="row">
                        ...
                        <div className="col-12 resources__downloads__outline__button">
                          <Link href="https://joel-transport.s3.af-south-1.amazonaws.com/static/Inventory_List.xls">
                            Download
                          </Link>
                        </div>
                      </div>
                    ...
                    <li className="col-6 resources__downloads__outline mb-5">
                      <div className="row">
                        ...
                        <div className="col-12 resources__downloads__outline__button">
                          <Link href="https://joel-transport.s3.af-south-1.amazonaws.com/static/Joel-Transport-RFA_Membership_Certificate_2023.pdf">
                            Download
                          </Link>
                        </div>
                      </div>
                    ...
                    <li className="col-6 resources__downloads__outline mb-5">
                      <div className="row">
                        ...
                        <div className="col-12 resources__downloads__outline__button">
                          <Link href="https://joel-transport.s3.af-south-1.amazonaws.com/static/Joel-Transport-Pty-Ltd-AMOSA_Member_Certificate_2020-.pdf">
                            Download
                          </Link>
                        </div>
                      </div>
