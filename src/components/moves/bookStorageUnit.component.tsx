...
const BookStorageUnit = () => {
    ...
    return <>
        ...
        <Alert variant="primary" className="mt-3">
            <div className="row">
                <div className="col-7">
                    <p style={{ fontSize: "1rem", }}><b>Recommended 4 Ton truck</b></p>
                    <p style={{
                        fontSize: "1rem",
                        fontWeight: "600"
                    }}> Loads: standard 2 bedroom house</p>
                    <p>There is enough space in this vehicle to fit an average double bed, two-seater couch, washing machine, double-door refrigerator, and a few other items.</p>
                </div>
                <div className="col-5" style={{ display: "grid", placeItems: "start end" }}>
