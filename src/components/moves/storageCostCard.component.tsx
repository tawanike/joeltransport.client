            ...
            <div className="col-12 storage-cost-card">
                <div className="row">
                    <div className="col-12 storage-cost-card__head">
                        <div className="row">
                            <div className="col-4 storage-cost-card__head--start"><p>Quote summary</p></div>
                            <div className="col-4 storage-cost-card__head--center"><p>First month's charges</p></div>
                            <div className="col-4 storage-cost-card__head--end"><p>Monthly charges</p></div>
                        </div>
