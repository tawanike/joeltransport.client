          ...
          <div className="container pt-5 pb-2">
            <div className="row">
              ...
              <div className="resources__pricing__description col-6 offset-3 my-3">
                <p>
                  Pricing for moving within a 60 km radius of Centurion. Click
                  on the get a quote button to get a free quote online or
                ...
                <div className="row">
                  {pricingConfig.map((price) => (
                    <>
                      <div
                        key={uuid()}
                        className="col-4 resources__pricing__prices-container"
                      >
                        <div className="col-12 resources__pricing__prices-container__item">
                          ...
                          <div className="col-10 offset-1 resources__pricing__prices-container__item-price">
                            <p>
                              {price.price}{" "}
                              <span className="exvat">/ex VAT</span>
                            </p>
                          </div>
                          {price.details.map((x) => (
                            <>
            ...
            <div className="row">
              ...
              <div className="resources__product-description__summary col-6">
                ...
                <div className="resources__product-description__summary__information-summary">
                  <p>
                    We offers full range of international moving service, from
                    packing, crating, shipping to customs clearance and storage.
                    To ensure that your move is smooth and seamless, we assign
                    you a personal move assistant to guide you through every
                    step.
                    <br />
                    <br />
                    The services we offer under International moves are: Lower
                    Container Load Service – where cargo is collected crated,
                    consolidated and dispatched in 30 days period. This is a
                    faster convenient solution for our clients. Full Container
                    Load Service – for larger loads of either 6 or 12 cubic
                    meter containers are used. This is faster and the most
                    efficient shipping method for larger loads. Air Freight
                    Service, this is the most preferred method by most
                    customers, it is fast and safe.
                  </p>
                </div>
